...
{   
    ...
    while(1)
	{
		...
		calculatePeekCoeff(0.7538962, 0.9114033, coeff6Peek1);
		calculatePeekCoeff(0.5383038, 0.0333732, coeff6Peek2);
		calculateShelvingCoeff(-0.4142136, coeff4HP);
		...
		for (i = 0; i < AUDIO_IO_SIZE; i++) {
			...
			output1[i] = shelvingLP(sampleBufferL[i], coeff4LP, &x_hLP, &y_hLP, k[0]);
