...

{
	...
	int i = 0;
	int k[4] = {32757, 32767, 32767, 32767};
	char character;
	int filter = 0;
    ...
    while(1)
    {
		...
		calculateShelvingCoeff(0.9063472, coeff4LP);
		calculatePeekCoeff(0.8956747, 0.9732792, coeff6Peek1);
		calculatePeekCoeff(0.5874300, 0.4522403, coeff6Peek2);
		calculateShelvingCoeff(-0.1583842, coeff4HP);
